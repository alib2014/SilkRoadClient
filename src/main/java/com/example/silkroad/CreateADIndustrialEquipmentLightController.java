...
public class CreateADIndustrialEquipmentLightController {
    ...
    public CreateADIndustrialEquipmentLightController() throws IOException {
    }
    ...
    void setAD(ActionEvent event) throws IOException {
        ...
        AD ad = new IndustrialEquipment(priceTextField.getText(), titleTextField.getText(), cityTextField.getText(),
                descriptionTextfield.getText(), ownerID);

        CreateSocket createSocket = new CreateSocket();
        Socket socket = createSocket.getSocket();
        BufferedWriter output = new BufferedWriter(new OutputStreamWriter(socket.getOutputStream()));

        String dataToServer = new JsonHandler().postNewAd(ad, "industrialEquipment");
