...
public class ExploreDarkController implements Initializable {
    ...
    void openAD1(MouseEvent event) throws IOException {
        ...
        AdsNumberHandler.addToHistory(AdsNumberHandler.ADsToShow.get(0).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
    ...
    void openAD2(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.ADsToShow.get(1).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
    ...
    void openAD3(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.ADsToShow.get(2).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
    ...
    void openAD4(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.ADsToShow.get(3).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
    ...
    void openAD5(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.ADsToShow.get(4).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
    ...
    void openAD6(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.ADsToShow.get(5).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
    ...
    void openAD7(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.ADsToShow.get(6).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
    ...
    void openAD8(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.ADsToShow.get(7).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
    ...
    void openADSuggest1(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.suggestedADs.get(0).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
        AdsNumberHandler.getSpecificAd(0);
        openAdsPage(AdsNumberHandler.category);
    }
    ...
    void openADSuggest2(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.suggestedADs.get(1).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
        AdsNumberHandler.getSpecificAd(1);
        openAdsPage(AdsNumberHandler.category);
    }
    ...
    void openADSuggest3(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.suggestedADs.get(2).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
        AdsNumberHandler.getSpecificAd(2);
        openAdsPage(AdsNumberHandler.category);
    }
    ...
    void openADSuggest4(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.suggestedADs.get(3).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
        AdsNumberHandler.getSpecificAd(3);
        openAdsPage(AdsNumberHandler.category);
    }
    ...
    void openADSuggest5(MouseEvent event) throws IOException {
        AccountHandler accountHandler = new AccountHandler();
        AdsNumberHandler.addToHistory(AdsNumberHandler.suggestedADs.get(4).getDatabaseID(), accountHandler.getAccount().getDatabaseID());
        AdsNumberHandler.getSpecificAd(4);
        openAdsPage(AdsNumberHandler.category);
    }
    ...
    public synchronized void openAdsPage (String category) throws IOException {
        switch (category) {
            ...
            case "Computer" : {
                PageController.close();
                PageController.open("ShowADComputerDark");
                break;
            }
            case "DigitalAccessories": {
                PageController.close();
                PageController.open("ShowADDigitalAccessoriesDark");
                break;
            }
            ...
            case "GamingConsole": {
                PageController.close();
                PageController.open("ShowADGamingDark");
                break;
            }
            case "PhoneAndTablet": {
                PageController.close();
            ...
            case "PersonalItem": {
                PageController.close();
                PageController.open("ShowADPersonalItemDark");
                break;
            }
            case "Building" : {
                PageController.close();
                PageController.open("ShowADBuildingDark");
                break;
            }
            case "Land" : {
                PageController.close();
                PageController.open("ShowADLandDark");
                break;
            }
            case "Bike" : {
                PageController.close();
            ...
            case "Motorcycle" : {
                PageController.close();
                PageController.open("ShowADMotorDark");
                break;
            }
        }
    }
