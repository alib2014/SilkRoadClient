...
public class ShowADIndustrialEquipmentDarkController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        if (new AccountHandler().getAccount().getDatabaseID() == AdsNumberHandler.industrialEquipment.getOwnerID())
        {
