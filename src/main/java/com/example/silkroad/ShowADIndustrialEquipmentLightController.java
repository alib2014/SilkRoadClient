...
public class ShowADIndustrialEquipmentLightController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        if (new AccountHandler().getAccount().getDatabaseID() == AdsNumberHandler.industrialEquipment.getDatabaseID())
        {
        ...
        IndustrialEquipment ad = AdsNumberHandler.industrialEquipment;
    ...
    public void bookmark(ActionEvent event) throws IOException {
        int adID = AdsNumberHandler.industrialEquipment.getDatabaseID();
    ...
    public void chatBox(ActionEvent event) throws IOException {
        int receiverID = AdsNumberHandler.industrialEquipment.getOwnerID();
    ...
    public synchronized void getPicture() throws IOException {
        String dataToServer = new JsonHandler().getAdPicture(AdsNumberHandler.industrialEquipment.getDatabaseID());
