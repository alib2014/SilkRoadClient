...
public class ShowADPersonalItemsDarkController implements Initializable {
    ...
    void switchLight(ActionEvent event) throws IOException {
        PageController.close();
        PageController.open("ShowADPersonalItemsLight");
    }

    @Override
    public void initialize(URL location, ResourceBundle resources) {
        if (new AccountHandler().getAccount().getDatabaseID() == AdsNumberHandler.personalItems.getOwnerID())
        {
