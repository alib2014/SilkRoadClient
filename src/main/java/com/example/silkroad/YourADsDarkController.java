...
public class YourADsDarkController implements Initializable {
    ...
    void switchLight(ActionEvent event) throws IOException {
        PageController.close();
        PageController.open("YourADsLight");
    }
    ...
    void nextPage(ActionEvent event) throws IOException {
        ...
        AdsNumberHandler.pageCounter += 1;
    ...
    public synchronized void openAdsPage (String category) throws IOException {
        switch (category) {
            ...
            case "Land" : {
                PageController.close();
                PageController.open("ShowADLLandDark");
                break;
            }
            case "Bike" : {
                PageController.close();
